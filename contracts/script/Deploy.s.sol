...
/// @notice Deploys ArcSwap to Arc Testnet: Factory, Router, two demo TestTokens (ARCT, DEMO),
...
contract DeployArcSwap is Script {
    function run() external {
        ...
        ArcSwapFactory factory = new ArcSwapFactory(deployer);
        ArcSwapRouter router = new ArcSwapRouter(address(factory));

        // Demo tokens — mint 1,000,000 to the deployer to seed a pool.
        TestToken arct = new TestToken("ArcSwap Token", "ARCT", 1_000_000 ether);
